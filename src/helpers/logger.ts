 ...
 */
export class Logger {
  static DEFAULT_LOG_STORAGE_FLAG_NAME = 'logger-enable'

  logStorageFlagName: string

  label: string | undefined

  color: string | undefined // TODO: calculate color based on label, support both browser and node
  ...
  protected get enableDebug() {
    ...
    this.enableDebug = enableDebugFromStorage
      ? enableDebugFromStorage === 'true'
      : true
  ...
  constructor(optionsOrLabel?: LoggerOptions | string) {
    ...
    const {
      enableDebug,
      logStorageFlagName = Logger.DEFAULT_LOG_STORAGE_FLAG_NAME,
      label
    } = options
